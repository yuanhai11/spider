...
def qget_distance(image1,image2):
    start=57
    threhold=60
...
def login_cnblogs(username,password):
    driver = webdriver.Chrome(executable_path=r'D:\wxt-new\chromedriver_win32\chromedriver.exe')
    try:
        # 1、输入账号密码回车
        ...
        input_pwd = driver.find_element_by_id('mat-input-1')
        signin = driver.find_element_by_class_name('mat-button-wrapper')
...
if __name__ == '__main__':
    login_cnblogs(username='linhaifeng',password='123456')