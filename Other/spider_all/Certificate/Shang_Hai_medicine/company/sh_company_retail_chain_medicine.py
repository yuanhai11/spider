        ...
        for i in results:
            ...
            if company_id:
                print((id,company_name,area,addr,street,warehouse,legal_people,company_principal,quality_principal,business_way,business_range,
                       license_num,license_name,license_mechanism,license_status,license_valid_date,license_invalid_date,gsp_license_num,
                       gsp_approve_valid_date,gsp_approve_invalid_date,company_id))
                if license_num not in bloom:
                    zhilian = Medicine(record_id=id,company_name=company_name,area=area,addr=addr,street=street,warehouse=warehouse,
                                       ...
                                       gsp_approve_valid_date=gsp_approve_valid_date,gsp_approve_invalid_date=gsp_approve_invalid_date,company_id=company_id,
                    ...
                    zhilian = Medicine(record_id=id, company_name=company_name, area=area, addr=addr, street=street,
                                       ...
                                       gsp_approve_invalid_date=gsp_approve_invalid_date, company_id=company_id,
                                       gmt_created=times, gmt_updated=times)
